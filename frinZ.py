...
"""+++ version +++
 ...
 version 4.2 (2024/12/29): JSON フォーマットで res-delay & res-rate を指定できるようにした．--delay-corr & --rate-corr を使わなくてもよい．
...
if delay_rate_json != False :
    ...
    try :
        delay_correct, rate_correct = json_load[ifile]
    except KeyError :
        print("# Not found res-delay and res-rate of %s so they are forced to be 0.0." % ifile)
        print("# Plese use --delay-corr and --rate-corr options!")
        delay_correct, rate_correct = 0.0, 0.0
